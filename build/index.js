...
function test(whatWeTest, actualResult, expectedResult, flagInverse = false) {
...
test('Counted unique types are NOT sorted', countRealTypes([{}, null, true, !null, !!null]), [
...
// Add several positive and negative tests
test('Counted unique types предварительно отсортированные', countRealTypes([{}, null, true, !null, !!null]), sortTypes([
    // А вот здесь типы предварительно сортируем
    ['boolean', 3],
    ['object', 1],
    ['null', 1],
]));
test('Counted unique types предварительно отсортированные', countRealTypes([{}, new Date(), true, !null, !!null, new Map()]), sortTypes([
    // А вот здесь типы предварительно сортируем
    ['boolean', 3],
    ['object', 1],
    // ['null', 1], - нету null
...
test('Невозможная ситуация', countRealTypes([{}, null, true, !null, !!null]), [
